...
src/
  sa_attendance_system/  Python CLI, HTTP API, SDK, service layer
tests/
...
- Person: student, teacher, staff, or unknown identity.
- Memory: durable facts and learned patterns that improve future decisions.
- Skill: replaceable capability such as capture, face recognition, assignment, export.
...
No cloud dependency is required for the first version. Person data and face data should
stay on the school Mac or local edge node by default.
